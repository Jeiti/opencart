<div class="module-gearbox-product gearbox-product-vertical gearbox-product-<?php echo $module['type'] ?> module-vert <?php echo $module['suffix'] ?>">
          ...
          <div class="product-thumb-inner">
            ...
            <div class="btn-group button-group">
              <button type="button" class="btn btn-primary btn-cart col-xs-6 col-lg-8" onclick="cart.add('<?php echo $product['product_id']; ?>');">
                <i class="fa fa-shopping-cart fa-lg"></i> <span class="hidden-sm"><?php echo $button_cart; ?></span>
              </button>
