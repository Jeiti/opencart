            ...
            <div class="uk-grid content-setting">
                <div class="uk-width-1-6 et-sidebar-tab">
                    <ul id="tab-nav" class="uk-tab uk-tab-left" data-uk-tab="{connect:'#content-main'}">
                        ...
                        <li id="tab-custom-style"><a><?php echo $text_custom_style; ?></a></li>
                            ...
                            <div id="content-templates" class="uk-switcher uk-margin-medium-top">
                                ...
                                <div class="uk-animation-fade">
                                    ...
                                    <div class="uk-button-group uk-button-layout-chooser" data-uk-button-radio>
                                        <label for="template-site-1" class="uk-button <?php echo ($setting['template_site'] == 'full') ? 'uk-active' : ''; ?>"><img src="view/stylesheet/default2/image/layout-site-full.png" alt=""></label>
                                        <label for="template-site-2" class="uk-button <?php echo ($setting['template_site'] == 'wide') ? 'uk-active' : ''; ?>"><img src="view/stylesheet/default2/image/layout-site-wide.png" alt=""></label>
                                        <label for="template-site-3" class="uk-button <?php echo ($setting['template_site'] == 'boxed') ? 'uk-active' : ''; ?>"><img src="view/stylesheet/default2/image/layout-site-boxed.png" alt=""></label>
                                        <label for="template-site-4" class="uk-button <?php echo ($setting['template_site'] == 'framed') ? 'uk-active' : ''; ?>"><img src="view/stylesheet/default2/image/layout-site-framed.png" alt=""></label>
                                    </div>
                                    <div class="uk-hidden">
                                        <input type="radio" id="template-site-1" name="template_site" value="full" <?php echo ($setting['template_site'] == 'full') ? 'checked' : ''; ?>>
                                        <input type="radio" id="template-site-2" name="template_site" value="wide" <?php echo ($setting['template_site'] == 'wide') ? 'checked' : ''; ?>>
                                        <input type="radio" id="template-site-3" name="template_site" value="boxed" <?php echo ($setting['template_site'] == 'boxed') ? 'checked' : ''; ?>>
                                        <input type="radio" id="template-site-4" name="template_site" value="framed" <?php echo ($setting['template_site'] == 'framed') ? 'checked' : ''; ?>>
                                    </div>
                                    ...
                                    <div class="uk-form-row">
                                        ...
                                        <div class="uk-form-controls">
                                            <input type="text" name="container_tablet" value="<?php echo $setting['container_tablet'] ?>" placeholder="750px" id="container-tablet" class="uk-width-3-20">
                                    ...
                                    <div class="uk-form-row">
                                        ...
                                        <div class="uk-form-controls">
                                            <input type="text" name="container_desktop" value="<?php echo $setting['container_desktop'] ?>" placeholder="970px" id="container-desktop" class="uk-width-3-20">
                                    ...
                                    <div class="uk-form-row">
                                        ...
                                        <div class="uk-form-controls">
                                            <input type="text" name="container_xdesktop" value="<?php echo $setting['container_xdesktop'] ?>" placeholder="1100px" id="container-xdesktop" class="uk-width-3-20">
                                ...
                                <div class="uk-animation-fade">
                                    ...
                                    <div class="uk-form-row">
                                        <label class="uk-form-label" for="template-category-specific-2"><?php echo $text_template_2; ?></label>
                                        <div class="uk-form-controls">
                                    ...
                                    <h2 class="uk-section"><?php echo $text_template_1; ?></h2>
                                    <div class="uk-form-row">
                                    ...
                                    <h2 class="uk-section"><?php echo $text_template_2; ?></h2>
                                    <div class="uk-form-row">
                                ...
                                <div class="uk-animation-fade">
                                    ...
                                    <div class="uk-form-row">
                                        <label class="uk-form-label" for="template-product-specific-2"><?php echo $text_template_2; ?></label>
                                        <div class="uk-form-controls">
                            ...
                            <div class="uk-grid">
                                ...
                                <div class="uk-width-1-1 uk-margin-medium-top">
                                    ...
                                    <ol class="uk-list-space">
                                        ...
                                        <li><b><?php echo $text_information_4; ?></b><?php echo $text_information_4_0; ?><br>
                                            <ol>
                                                <li><?php echo $text_information_4_1; ?></li>
                                                <li><?php echo $text_information_4_2; ?></li>
                                                <li><?php echo $text_information_4_3; ?></li>
                                                <li><?php echo $text_information_4_4; ?></li>
                                                <li><?php echo $text_information_4_5; ?></li>
                                            </ol>
                                        </li>
                                        <li><?php echo $text_information_5; ?></li>
                                    </ol>
                                </div>
                            </div>
                        </div>
...
$(document).ready(function()
{
    ...
    var customCM = CodeMirror.fromTextArea(document.getElementById('custom-style'), {
        mode: 'text/x-less',
        tabSize: 2,
        indentUnit: 2,
        lineNumbers: true,
