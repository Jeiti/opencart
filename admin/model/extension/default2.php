...
class ModelExtensionDefault2 extends Model
{
    public function installApp($version)
    {
        ...
        //=== Layout
        $this->db->query("INSERT INTO " . DB_PREFIX . "layout SET name = 'All Page Layout'");
    ...
    {
        $value = $this->defaultPreset($preset_id, 'New Preset #' . $preset_id);
    ...
    public function defaultPreset($id=0, $name='Default')
    {
        return array(
            'store_id'                      => 0,
            'preset_id'                     => $id,
            ...
            // Templates
            'template_site'                 => 'wide',
            'container_tablet'              => '750px',
            'container_desktop'             => '970px',
            'container_xdesktop'            => '1100px',
    ...
    private function blockPositionDemo()
    {
        ...
        //=== Insert layout
        $this->db->query("INSERT INTO " . DB_PREFIX . "layout SET name = 'Layout Block Demo'");
        $layout_id = $this->db->getLastId();
        ...
        foreach ($languages as $language) {
            $description[$language['language_id']] = array(
                ...
                'description'       => "<style>.position-block{margin:-5px;padding:4px 5px 5px;background:#FFF7D0}#column-left .oc-module,#column-right .oc-module,#sidebar-left .oc-module,#sidebar-right .oc-module,#content-top .oc-module,#content-bottom .oc-module{margin:-5px;padding:4px 5px 5px;background:#FFF7D0}#column-left .example-block-blue,#column-right .example-block-blue,#sidebar-left .example-block-blue,#sidebar-right .example-block-blue,#column-left .example-block-red,#column-right .example-block-red,#sidebar-left .example-block-red,#sidebar-right .example-block-red{padding:296px 10px}.example-block-gray{padding:38px 20px}#column-left .oc-module:before,#column-right .oc-module:before,#sidebar-left .oc-module:before,#sidebar-right .oc-module:before,#content-top .oc-module:before,#content-bottom .oc-module:before,.position-block:before{font-size:12px;font-family:monospace;margin-bottom:10px;display:inline-block;background:#d00;line-height:12px;color:#fff;padding:2px 5px;border-radius:3px}#position-tlb-top-left:before{content:'#tlb-top-left'}#position-tlb-top-right:before{content:'#tlb-top-right'}#position-main-menu:before{content:'#main-menu'}#position-top-a:before{content:'#top-a'}#position-top-b:before{content:'#top-b'}#position-top-c:before{content:'#top-c'}#column-left .position-block:before{content:'#column-left'}#column-right .position-block:before{content:'#column-right'}#sidebar-left .position-block:before{content:'#sidebar-left'}#sidebar-right .position-block:before{content:'#sidebar-right'}#position-content-top-a:before{content:'#content-top-a'}#position-content-top-b:before{content:'#content-top-b'}#content-top .oc-module:before{content:'#content-top'}#content-bottom .oc-module:before{content:'#content-bottom'}#position-content-btm-a:before{content:'#content-btm-a'}#position-content-btm-b:before{content:'#content-btm-b'}#position-bottom-a:before{content:'#bottom-a'}#position-bottom-b:before{content:'#bottom-b'}#position-bottom-c:before{content:'#bottom-c'}.position-toolbar .position-block{margin:5px -5px}#position-tlb-btm-left:before{content:'#tlb-btm-left'}#position-tlb-btm-right:before{content:'#tlb-btm-right'}#position-footer-ribbon:before{content:'#footer-ribbon'}#position-footer-a:before{content:'#footer-a'}#position-footer-b:before{content:'#footer-b'}#position-footer-c:before{content:'#footer-c'}</style><p>Visual example of block-position</p>",
        ...
        $modules = array(
            ...
            array('Example Responsive Utilities', '<div style="width:200px; position:fixed; top:0; left:50%; margin-left:-100px; background:rgba(0,0,0,.65); color:#fff; font-size:11px; padding:2px 0; z-index:10000" class="text-danger text-center"><span class="visible-xs-block">Extra Small - Phones (&lt;768px)</span><span class="visible-sm-block">Small - Tablets (≥768px)</span><span class="visible-md-block">Medium - Desktops (≥992px)</span><span class="visible-lg-block">Large - Desktops (≥1200px)</span></div>'),
        );
